...
public unsafe class ActivationFunction : BaseFunction<ActivationFunction>
{
    ...
    public sealed unsafe class LogisticSigmoid // Logistic, sigmoid, or soft step.
    {
    ...
    public sealed unsafe class SymmetricSigmoid
    {
    ...
    public sealed unsafe class Identiy
    {
    ...
    public sealed unsafe class Linear
    {
    ...
    public sealed unsafe class Softsign
    {
    ...
    public sealed unsafe class Tanh // Hyperbolic tangent.
    {
    ...
    public sealed unsafe class ReLu // Rectified linear unit.
    {
    ...
    public sealed unsafe class LeakyReLu // Leaky rectified linear unit.
    {
    ...
    public sealed unsafe class StepConst
    {
    ...
    public sealed unsafe class BinaryStep
    {
    ...
    public sealed unsafe class Softplus
    {
    ...
    public sealed unsafe class ELU // Exponential linear unit.
    {
    ...
    public sealed unsafe class SELU // Scaled exponential linear unit.
    {
